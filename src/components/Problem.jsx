  ...
  return (
    <section ref={ref} className={`py-24 px-6 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-white/55 text-lg mb-16 text-center">Large facilities are mazes. Visitors are lost. Time and dignity are wasted.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-black/20 backdrop-blur-xl border border-white/[0.08] rounded-2xl p-8 text-center">
            ...
            <p className="text-white/55 mt-3 text-sm leading-relaxed">Average time a visitor spends finding their department in a large facility</p>
          </div>
          <div className="bg-black/20 backdrop-blur-xl border border-white/[0.08] rounded-2xl p-8 text-center">
